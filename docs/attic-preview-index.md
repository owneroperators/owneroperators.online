# Attic — deleted preview index (Louuy)

Recovered from the retired `content/preview/_index.md` (the /preview/ landing page,
removed 2026-07-03 and redirected to home). Kept here for the Louuy ornament +
the mp3-player markup, in case either is wanted again.

The Louuy "three versions of themselves" ornament also lives in
`data/ornaments.yaml` under the `versions` key.
