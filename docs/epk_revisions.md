...
- Written, performed, and produced by **Eric Eaglstun** (vocals, guitar, synths, most instruments tracked).
- Recorded largely as a solo studio project; now performing as a live trio with **Caleb Ebe** (drums) and **Mike Shumann** (bass).
- Album drum takes by session players via **Musiversal** (Gonzalo Eyzaguirre, Chris Barber).
